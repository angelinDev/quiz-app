...
export const ScoreBlock: React.FC<ScoreBlockProps> = ({ score, total, onRestart }) => (
  <div className="max-w-xs w-full mx-auto rounded-2xl p-0 flex flex-col items-center justify-center animate-fade-in-up relative overflow-hidden bg-black mt-8 py-8" style={{ minWidth: 260, maxWidth: 380 }}>
    ...
    <div className="flex gap-4 mt-2">
      <Link href="/" className="px-4 py-2 rounded-xl bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-700 border border-yellow-400/40 text-yellow-300 font-bold shadow hover:bg-neutral-800 hover:text-yellow-200 transition-colors">Accueil</Link>
      <button
        onClick={onRestart}

...
function QuestionLayout() {
  return (
    <div className="max-w-md w-full mx-auto rounded-2xl p-0 flex flex-col gap-0 animate-fade-in-up relative overflow-hidden bg-black mt-8">
      {/* Halo néon animé */}
      ...
      <div className="text-lg md:text-xl font-black text-yellow-100 text-center drop-shadow-xl mb-3 px-4 pb-1 pt-1 uppercase tracking-widest z-10">
        Combien d'animaux possède le roi d'Angleterre ?
      </div>
